...
- **Architecture**: MultiTaskRestorer
...
# 1. Initialize
model = create_model("professional_multitask_restoration")
model.load_state_dict(torch.load("professional_multitask_restoration_latest.pth"))
model.eval()
