...
def generate_inference_notebook(model_key, export_dir, unified_models_registry=None, config=None):
    ...
    hardware_sentinel_source = [
        ...
        "    print('=' * 78 + '\\n')\n",
        "    raise RuntimeError(f'Incompatible Accelerator: {_smi_gpu}. Please switch to GPU T4 x2 in Kaggle Session Options.')\n",
        "\n",
        "import torch\n",
        ...
        "        raise RuntimeError(f'Incompatible Accelerator: {props.name} (sm_{cap[0]}{cap[1]}). Please switch to GPU T4 x2.')\n",
