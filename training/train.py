            ...
            "cells": [
                ...
                },
                {
                    ...
                    "source": [
                        ...
                        "        try:\n",
                        "            model = ld_func(model_path, map_location=device, weights_only=False)\n",
                        "        except TypeError:\n",
                ...
                },
                {
                    ...
                    "source": [
                        ...
                        "\n",
                        "# 2026 Resilience: Always ensure we are on the 'main' branch for the hub\n",
                        "subprocess.run(['git', 'branch', '-M', 'main'], cwd=hub_root)\n",
                        "\n",
                        "# 2026 Resilience: Always enforce identity to prevent 'Author identity unknown' on pre-existing repos\n",
