            ...
            "cells": [
                ...
                },
                {
                    ...
                    "source": [
                        ...
                        "    import glob\n",
                        "    paths = glob.glob('/kaggle/input/*/LemGendary" + pascal_model_name + ".pth') + [\n",
                        "        f'/kaggle/working/LemGendary" + pascal_model_name + ".pth', \n",
                        "        'LemGendary" + pascal_model_name + ".pth'\n",
                        "    ]\n",
                        ...
                        "    else:\n",
                        "        print('[INFO] No pre-trained PyTorch weights found. Starting from baseline.')\n",
                        ...
                        "    import glob\n",
                        "    paths = glob.glob('/kaggle/input/*/LemGendary" + pascal_model_name + ".onnx') + [\n",
                        "        f'/kaggle/working/LemGendary" + pascal_model_name + ".onnx', \n",
                        "        'LemGendary" + pascal_model_name + ".onnx'\n",
                        "    ]\n",
